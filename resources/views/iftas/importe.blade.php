            ...
            <div class="col-lg-10 col-md-10 col-sm-12 ">
                <div class="card">
                    ...
                    <div class="card-body px-lg-5 pt-0">
                        ...
                        <div class="md-form">
                            <form class="md-form" action="{{ route('iftas.submit') }}" method="POST"
                                ...
                                <div class="file-field">
                                    ...
                                    <div class="file-path-wrapper">
                                        <input class="file-path validate text-primary" placeholder="please choose the excel file you downloaded fro KeepTracking website" type="text">
                                    </div>
                                </div>
